...
def parse_args():
    ...
    parser.add_argument("--yes", action="store_true", help="Skip confirmation and proceed automatically")
...
if __name__ == "__main__":
    ...
    for model_name in ["ada"]:
        start_finetunes(
            ...
            "d2p_reverse_prompts_test.jsonl",  # Changed from validation_prompts.jsonl to avoid single-word completions
